...
* ### setUrlLevel
  ...
  > Возвращает сообщение с кнопками для выбора уровня запрета ссылок

* ### setAI

  > Возвращает сообщение с кнопкой для переключения режима работы искусственного интеллекта
